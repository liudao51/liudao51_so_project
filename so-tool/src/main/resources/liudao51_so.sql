...
CREATE TABLE `article`(
	`id` BIGINT(20) NOT NULL COMMENT 'article_id',
...
CREATE TABLE `article_content`(
  `id` BIGINT(20) NOT NULL COMMENT 'article_content_id',
  `article_id` BIGINT(20) NOT NULL COMMENT 'article_id',
...
CREATE TABLE `article_keyword`(
	`id` BIGINT(20) NOT NULL COMMENT 'article_keyword_id',
	`article_id` BIGINT(20) NOT NULL COMMENT 'article_id',
	`content` VARCHAR(5000) NOT NULL DEFAULT 0 COMMENT '内容',
	`created_time` BIGINT(20) NOT NULL DEFAULT 0 COMMENT '创建时间',
	`updated_time` BIGINT(20) NOT NULL DEFAULT 0 COMMENT '更新时间',
